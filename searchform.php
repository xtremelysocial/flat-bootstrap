...
<div class="form-group">
	<label>
		...
		<input type="search" class="search-field" placeholder="<?php echo esc_attr_x( 'Search &hellip;', 'placeholder', 'flat-bootstrap' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s">
	</label>
